    ...
    OnAllServicesOnline() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield rest_client_1.RestClient.Post(`http://${Conf_1.default.SERVICES[this.GetName()]["camera_ip"]}:${Conf_1.default.SERVICES[this.GetName()]["camera_port"]}${Conf_1.default.SERVICES[this.GetName()]["camera_path"]}/start`);
                ...
                for (const img of camera)
                    yield rest_client_1.RestClient.Get(`http://${Conf_1.default.SERVICES[this.GetName()]["camera_ip"]}:${Conf_1.default.SERVICES[this.GetName()]["camera_port"]}${Conf_1.default.SERVICES[this.GetName()]["camera_path"]}/download/${img.id}`);
            }
            catch (e) {
                this.logger.Error(e);
            }
